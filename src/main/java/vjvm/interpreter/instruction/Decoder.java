...
import vjvm.interpreter.instruction.stacks.DUPX;
import vjvm.interpreter.instruction.stacks.DUPX_XX;
import vjvm.interpreter.instruction.stacks.POPX;
import vjvm.interpreter.instruction.stacks.SWAP;
import vjvm.interpreter.instruction.store.XSTORE;
...
public class Decoder {
  ...
  // @formatter:off
      /* 0x00 */  NOP::new, null, XCONST_Y::ICONST_M1, XCONST_Y::ICONST_0,
      ...
      /* 0x58 */  POPX::POP2, DUPX::DUP, DUPX::DUP2, null,
      /* 0x5c */  null, null, null, SWAP::new,
      ...
      /* 0x78 */  XOPR::ISHL, LIOPR::LSHL, XOPR::ISHR, LIOPR::LSHR,
      /* 0x7c */  XOPR::IUSHR, LIOPR::LUSHR, XOPR::IAND, XOPR::LAND,
      /* 0x80 */  XOPR::IOR, XOPR::LOR, XOPR::IXOR, XOPR::LXOR,
      /* 0x84 */  IINC::new, X2Y::I2L, X2Y::I2F, X2Y::I2D,
      ...
      /* 0xa0 */  IF_XCMPCOND::IF_ICMPNE, IF_XCMPCOND::IF_ICMPLT, IF_XCMPCOND::IF_ICMPGE, IF_XCMPCOND::IF_ICMPNT,
      /* 0xa4 */  IF_XCMPCOND::IF_ICMPLE, IF_XCMPCOND::IF_ACMPEQ, IF_XCMPCOND::IF_ACMPNE, GOTO::new,
      /* 0xa8 */  null, null, null, null,
      /* 0xac */  XRETURN::IRETURN, XRETURN::LRETURN, XRETURN::FETURN, XRETURN::DETURN,
