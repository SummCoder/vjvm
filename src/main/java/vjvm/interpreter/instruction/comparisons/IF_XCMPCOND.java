...
public class IF_XCMPCOND extends Instruction {
  ...
  public static IF_XCMPCOND IF_ACMPEQ(ProgramCounter pc, MethodInfo method){
    return new IF_XCMPCOND((x, y) -> Objects.equals(x, y), "if_acmpeq", pc);
  }
  ...
  public static IF_XCMPCOND IF_ICMPEQ(ProgramCounter pc, MethodInfo method){
    return new IF_XCMPCOND((x, y) -> Objects.equals(x, y), "if_icmpea", pc);
  }
  ...
  public static IF_XCMPCOND IF_ICMPNT(ProgramCounter pc, MethodInfo method){
